...
@interface DITServer () <NSNetServiceDelegate>
...
- (void)_startListening:(DITCompletionBlock)inResultHandler
    {
//getifaddrs
...
- (void)_startPublishing:(DITCompletionBlock)inResultHandler
    {
...
- (void)_stopPublishing:(DITCompletionBlock)inResultHandler
    {
    NSParameterAssert(self.netService != NULL);
...
- (void)netServiceDidPublish:(NSNetService *)sender
    {
    DITCompletionBlock theBlock = sender.dit_userInfo;
    if (theBlock)
        {
        theBlock(NULL);
...
static void TCPSocketListenerAcceptCallBack(CFSocketRef inSocket, CFSocketCallBackType inCallbackType, CFDataRef inAddress, const void *inData, void *ioInfo)
    ...
    DITServer *theServer = (__bridge DITServer *)ioInfo;
