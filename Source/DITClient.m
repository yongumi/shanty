...
- (void)connect:(DITCompletionBlock)inCompletionBlock;
    {
...
- (void)_resolve:(DITCompletionBlock)inCompletionBlock;
    {
...
- (void)_connect:(DITCompletionBlock)inCompletionBlock;
    {
    ...
    DITCompletionBlock theBlock = ^(NSError *inError) {
...
//static void MyCFHostClientCallBack(CFHostRef theHost, CFHostInfoType typeInfo, const CFStreamError *error, void *info)
//    {
//    DITClient *theClient = (__bridge DITClient *)info;
//
//    Boolean theResolvedFlag = NO;
...
static void MyCFSocketCallBack(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void *data, void *info)
    ...
    if (type == kCFSocketConnectCallBack)
        {
        DITCompletionBlock theBlock = (__bridge DITCompletionBlock)info;
        theBlock(NULL);
        }
    }
